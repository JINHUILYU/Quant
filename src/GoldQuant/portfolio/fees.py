...
# Rates inferred from historical transaction data (fee / (amount - fee)).
BUY_FEE_RATES: dict[str, float] = {
    ...
    "009505": 0.0,
    "008987": 0.0,
    # A 类基金 — 申购费率（平台折扣后，从历史交易推理）
    "001302": 0.0015,   # 前海开源金银珠宝混合A      — 0.15% (19笔一致)
    "519674": 0.0015,   # 银河创新成长混合A          — 0.15% (21笔,大额)
    "016452": 0.0012,   # 南方纳斯达克100 A          — 0.12% (19笔一致)
    "110020": 0.0012,   # 易方达沪深300ETF联接A       — 0.12% (17笔一致)
    "161226": 0.0010,   # 国投瑞银白银期货LOF A       — 0.10% (3笔一致)
    "270042": 0.0010,   # 广发纳斯达克100 QDII A     — 0.10% (24笔一致)
    "470007": 0.0010,   # 汇添富上证综合指数A         — 0.10% (2笔一致)
    "000218": 0.0007,   # 国泰黄金ETF联接A            — 0.07% (1笔)
}
